...
import { ArrowDownToLine, ArrowUpFromLine, Clock, Cpu, Database, DollarSign } from 'lucide-react';
...
export function LogMetrics({ log, now, brandColor, variant }: { log: RelayLogOverview; now: number; brandColor: string; variant: 'card' | 'footer' }) {
